...
export default function EasyMode() {
  ...
  return (
    <div className="flex items-center justify-center p-4 bg-slate-100 font-sans" id='easy-mode'>
      <div className="w-full max-w-4xl bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        {/* Section Tabs */}
        <div className="flex justify-center space-x-2 bg-gray-50 pt-6 pb-2">
          <button
        ...
        <div className="p-6">
            ...
            <>
              <div className="mb-8">
                <div className="bg-gray-100 rounded-lg p-6 mb-4">
                  <div className="typing-text text-xl md:text-2xl font-mono text-center leading-relaxed">
                    {letters.map((char, i) => (
                      <span
                        key={i}
                        className={
                ...
                <div className="bg-green-50 border border-green-100 rounded-lg p-6 mb-6">
                  ...
                  <div className="flex justify-center">
                    <button
                      ...
                      className="w-[25%] mt-6 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors duration-200 font-medium"
                    >
                      Try Again
                    </button>
                    <button
                      onClick={shuffleLetters}
                      className="w-[25%] mt-6 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors duration-200 font-medium me-3"
                    >
                      Shuffle
                    </button>
                  </div>
          ...
          {section === 'words' && (
            <>
              <div className="mb-4">
                <div className="bg-gray-100 rounded-lg p-6 mb-4">
                  <div className="typing-text text-xl md:text-2xl font-mono text-center leading-relaxed break-words">
                    {words.length === 0 && (
                ...
                <div className="bg-green-50 border border-green-100 rounded-lg p-6 mb-6">
                  ...
                  <div className="flex justify-center space-x-2">
                    <button
                      ...
                      className="w-[25%] mt-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg transition-colors duration-200 font-medium"
                    >
                      Try Again
                    </button>
                    <button
